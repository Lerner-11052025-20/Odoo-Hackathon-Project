...
import { Plus, LayoutList, Layers, Truck } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <Truck className="text-blue-500" /> Delivery Orders
            </h1>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage outgoing stock to customers</p>
          </div>
